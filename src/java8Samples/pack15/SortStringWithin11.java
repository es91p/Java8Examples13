package java8Samples.pack15;

import java.util.List;
import java.util.stream.Collectors;
import java.util.stream.Stream;

public class SortStringWithin11 {
    public static void main(String[] args)
    {
        ...
        List<Character> strList = str.chars().mapToObj(ch -> (char) ch).sorted().collect(Collectors.toList());
        System.out.println("Original string 13  : " + str);
        System.out.println("After sorting  string : " + strList);
       String Str14 = strList.stream().map(ch -> ch.toString()).collect(Collectors.joining());
        ...
        System.out.println("Original string 132  : " + str);
